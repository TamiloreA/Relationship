    ...
    <div className="min-h-screen w-full bg-black/20 flex flex-col items-center justify-center">
      <div className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className='w-[90%] max-w-[400px]'>
          ...
          My love, as we step into this new year together, I wish you endless joy and boundless laughter. May your days be filled with love, warmth, and dreams coming true. You are the brightest star in my sky, and I’ll cherish every moment by your side. Here’s to a beautiful year ahead, filled with our happiest memories yet!
          </p>
